...
- Player 校验包含 BuildReport、目标场景、AMD64 架构、必要运行时文件、逐文件哈希和范围外差异检查。该基线只证明 Bootstrap-only Windows64 自动化，不代表 Player 启动、人工场景、性能或项目级 Full Verified。
...
- 本切片未运行 EditMode、PlayMode、生成 Player 启动、人工主线场景验收或性能检查，因此不声明整个项目 Full Verified 或 Accepted。
